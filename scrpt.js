...
for (var producto of arrayProductos) {
    ...
    document.write("<1i><h3> Precio con IVA es: " + producto.sumarIva() + "'</h3></li></ul><br>");
...
for (var producto of pocoStock) {
    document.write("<ul><li><h3>Nombre:" + producto.nombre + "</h3></li>");
    document.write("<li><h3> Detalle: " + producto.detalle + "</h3></li>");
    document.write("<li><h3> Cantidad: " + producto.cantidad + "</h3></lix/ul><br>");
}
...
for (var producto of prodingresado) {
    document.write("<ul><li><h3>Nombre: " + producto.nombre + "</h3></li>");
    document.write("<li><h3> Detalle: " + producto.detalle + "</h3></11>");
    document.write("<li><h3> Precio: " + producto.precio + "</h3></11></ul>br>");
}
...
for (var producto of ordenadosCantidad) {
    document.write("<ul><li><h3>Nombre: " + producto.nombre + "</h3></li>")
    document.write("<li><h3> Detalle: " + producto.detalle + "</h3></li>");
    document.write("<11><h3> Cantidad: " + producto.cantidad + "</h3></li></ul><br>");
}
